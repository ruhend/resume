...
%-------------------------------------------------------------------------------
\name{Mudigonda }{Himansh}
% \position{B.Tech. Student{\enskip\cdotp\enskip}Computer Science{\enskip\cdotp\enskip}GPA: 9.22}
% \address{SRM University, Amaravati, Andra Predesh}

\mobile{+91 9908-102-232}
\email{mudigonda.himanshh@gmail.com}
\homepage{ruhend.github.io/links}
\github{github.com/ruhend}
% \linkedin{linkedin.com/in/himansh-m}
% \gitlab{my-gitlab-id}
...
\makecvfooter
  {Feb 2022}
  {Mudigonda Himansh ~~~·~~~ Curriculum Vitae}
  {\thepage}
